...
void view_ALARM(void)
{
    ...
    if(f==2)
    {
        ...
        for(k=0;k<8;k++)
        {
           clcd_putch(view_event[count][k],(0x80 + (line_variable)));
            line_variable++;
        }
       clcd_print("  *",(0x80 + (line_variable)));
        line_variable=0;
       clcd_putch(count+'0',(0xC0 + (line_variable++)));
        clcd_print(" D- ",(0xC0 + (line_variable)));
        line_variable=5;
        for( ;k<18;k++)
        {
           clcd_putch(view_event[count][k],(0xC0 + (line_variable)));
            line_variable++;
        }
        if(key==2)
        {
...
void set_EVENT(void)
{
   ...
   clcd_print(STORE_TIME,(0x80 + (4)));
   clcd_print("   ",(0x80 + (12)));
    clcd_putch('*',(0x80 + (15)));
   clcd_print("DUR - ",(0xC0 + (0)));
   clcd_print(duration,(0xC0 + (6)));
...
void set_time(void)
{
    ...
    if(key==2)
    {
        if(AM_PM)
        {
        write_ds1307(0x02,((0x00<<5)|((0x01)<<6)|(hour/10)<<4)|(hour%10));
        }
        else
        {
           write_ds1307(0x02,((0x01<<5)|((0x01)<<6)|(hour/10)<<4)|(hour%10));
        }
        write_ds1307(0x01,((minute/10)<<4)|(minute%10));
...
void set_date(void)
{
   ...
   date[9] = '0' + year%10;
      ...
      if(key==2)
      {
           write_ds1307(0x06,((year/10)<<4)|(year%10));
           write_ds1307(0x05,((month/10)<<4)|(month%10));
           write_ds1307(0x04,((DATE/10)<<4)|(DATE%10));
           write_ds1307(0x03,((day/10)<<4)|(day%10));
           f=0;
           flag=0;
           stop=0;
           GIE=1;
...
int GOTO_SET_TIMEDATA(void)
{
    ...
    else if(oper1==2)
    {
     ...
     clcd_print("SET TIME      ",(0x80 + (2)));
     clcd_print("SET DATE      ",(0xC0 + (2)));
...
void GOTO_SET_EVENT(void)
{
    ...
    {
        clcd_write(0x01, 0);
     clcd_print("VIEW EVENT    ",(0x80 + (2)));
     clcd_print("SET EVENT     ",(0xC0 + (2)));
 ...
 while (1)
 {
        ...
        if(seconds_flag==1)
        {
            ...
            f=2;
              int j=0;
               ...
               for(i=0;i<8;i++)
               {
                   clcd_putch(view_event[p][i],(0x80 + (j)));
                   j++;
               }
               j=0;
               for(;i<18;i++)
               {
                   clcd_putch(view_event[p][i],(0xC0 + (j)));
                   j++;
               }
      ...
      display_time();
       ...
       else if(flag==1)
       {
          ...
          clcd_print("SET_TIME/DATE ",(0x80 + (2)));
            clcd_print("SET/VIEW EVENT",(0xC0 + (2)));
